...
class CacheableKeyType : public DataSerializablePrimitive, public CacheableKey {
 protected:
  TObj m_value;
...
class CacheableContainerType : public DataSerializablePrimitive, public TBase {
 protected:
...
class _GEODE_EXPORT CacheableArray : public DataSerializablePrimitive {
 protected:
