...
PUBLIC interface class IRegion : public System::Collections::Generic::IDictionary<TKey, TValue> {
 public:
  ...
  /// <seealso cref="Put" />
  /// <seealso cref="Get" />
  void Add(TKey key, TValue value, gc_ptr(Object) callbackArg);
  ...
  /// This method also returns false if key was not found in the original IDictionary.
  /// </returns>
  bool Remove(TKey key, gc_ptr(Object) callbackArg);
  ...
  /// If the Equals function is not overriden in the TValue class the behavior of this function is undefined. Hence,
  /// this function won't work properly for the .NET types that uses the default implementation of the Equals method,
  /// for e.g. arrays.
  /// </para>
  /// </remarks>
  /// <param name="keyValuePair">
  ...
  /// </param>
  void Clear(gc_ptr(Object) callbackArg);
  ...
  /// <seealso cref="Get" />
  /// <seealso cref="Add" />
  void Put(TKey key, TValue value, gc_ptr(Object) callbackArg);
  ...
  /// </exception>
  /// <seealso cref="Put" />
  TValue Get(TKey key, gc_ptr(Object) callbackArg);
  ...
  /// <seealso cref="DestroyRegion" />
  /// <seealso cref="ICacheListener.AfterRegionInvalidate" />
  void InvalidateRegion(gc_ptr(Object) callbackArg);
  ...
  /// </exception>
  /// <seealso cref="InvalidateRegion" />
  void DestroyRegion(gc_ptr(Object) callbackArg);
  ...
  /// <seealso cref="Destroy" />
  /// <seealso cref="ICacheListener.AfterInvalidate" />
  void Invalidate(TKey key, gc_ptr(Object) callbackArg);
  ...
  /// </exception>
  /// <seealso cref="Put" />
  void PutAll(gc_ptr(IDictionary<TKey, TValue>) map);
  ...
  /// response. It should be less than or equal to gc_ptr(2)31/1000 i.e. 2147483.
  /// Optional.
  /// </param>
  /// <exception cref="IllegalArgumentException">
  /// If timeout is more than gc_ptr(2)31/1000 i.e. 2147483.
  /// </exception>
  /// <exception cref="NullPointerException">
  /// if any value in the map is null
  /// </exception>
  ...
  /// </exception>
  /// <seealso cref="Put" />
  void PutAll(gc_ptr(IDictionary<TKey, TValue>) map, TimeSpan timeout);
  ...
  /// </exception>
  /// <seealso cref="Put" />
  void PutAll(gc_ptr(IDictionary<TKey, TValue>) map, TimeSpan timeout, gc_ptr(Object) callbackArg);
  ...
  /// </exception>
  /// <seealso cref="Get"/>
  void RemoveAll(gc_ptr(System::Collections::Generic::ICollection<TKey>) keys);
  ...
  /// </exception>
  /// <seealso cref="Remove"/>
  void RemoveAll(gc_ptr(System::Collections::Generic::ICollection<TKey>) keys, gc_ptr(Object) callbackArg);
  ...
  /// region's pathname
  /// </returns>
  property gc_ptr(String) FullPath { gc_ptr(String) get(); }
  ...
  /// </exception>
  property gc_ptr(IRegion<TKey, TValue>) ParentRegion { gc_ptr(IRegion<TKey, TValue>) get(); }
  ...
  /// region's attributes
  /// </returns>
  property gc_ptr(RegionAttributes<TKey, TValue>) Attributes { gc_ptr(RegionAttributes<TKey, TValue>) get(); }
  ...
  /// if the region has been destroyed
  /// </exception>
  property gc_ptr(AttributesMutator<TKey, TValue>) AttributesMutator {
  ...
  /// </exception>
  property gc_ptr(CacheStatistics) Statistics { gc_ptr(CacheStatistics) get(); }
  ...
  gc_ptr(IRegion<TKey, TValue>) GetSubRegion(gc_ptr(String) path);
  ...
  /// </exception>
  System::Collections::Generic::ICollection<gc_ptr(IRegion<TKey, TValue>)> ^ SubRegions(bool recursive);
  ...
  /// </exception>
  gc_ptr(Client::RegionEntry<TKey, TValue>) GetEntry(TKey key);
  ...
  System::Collections::Generic::ICollection<gc_ptr(Client::RegionEntry<TKey, TValue>)> ^ GetEntries(bool recursive);

  /// <summary>
  /// Gets the RegionService for this region.
  /// </summary>
  /// <returns>RegionService</returns>
  property gc_ptr(Apache::Geode::Client::IRegionService) RegionService {
  ...
  /// if it is called by local region instance <see cref="Region.GetLocalView" />
  /// </exception>
  gc_ptr(ISubscriptionService<TKey>) GetSubscriptionService();
  ...
  /// if it is called by local region instance <see cref="Region.GetLocalView" />
  /// </exception>
  gc_ptr(IRegion<TKey, TValue>) GetLocalView();
  ...
  /// </returns>
  GENERIC(class TResult)
  gc_ptr(ISelectResults<TResult>) Query(gc_ptr(String) predicate);
  ...
  /// </returns>
  GENERIC(class TResult)
  gc_ptr(ISelectResults<TResult>) Query(gc_ptr(String) predicate, TimeSpan timeout);
  ...
  /// </returns>
  bool ExistsValue(gc_ptr(String) predicate);
  ...
  /// true if the result size is non-zero, false otherwise.
  /// </returns>
  bool ExistsValue(gc_ptr(String) predicate, TimeSpan timeout);
  ...
  /// </returns>
  gc_ptr(Object) SelectValue(gc_ptr(String) predicate);
  ...
  /// or NULL of no results are available.
  /// </returns>
  gc_ptr(Object) SelectValue(gc_ptr(String) predicate, TimeSpan timeout);
};
}  // namespace Client
}  // namespace Geode
}  // namespace Apache
