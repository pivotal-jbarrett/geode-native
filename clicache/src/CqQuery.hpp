...
PUBLIC ref class CqQuery sealed {
 public:
  ...
  /// </summary>
  gc_ptr(ICqResults<TResult>) ExecuteWithInitialResults();
  ...
  /// </param>
  gc_ptr(ICqResults<TResult>) ExecuteWithInitialResults(TimeSpan timeout);
  ...
  /// </summary>
  gc_ptr(CqAttributes<TKey, TResult>) GetCqAttributes();

  /// <summary>
  /// Get the Attributes Mutator for this cq query.
  /// </summary>
  gc_ptr(CqAttributesMutator<TKey, TResult>) GetCqAttributesMutator();

  /// <summary>
  /// Get the stats for this cq query.
  /// </summary>
  gc_ptr(CqStatistics) GetStatistics();

  /// <summary>
  /// Get the Query for this cq query.
  /// </summary>
  gc_ptr(Query<TResult>) GetQuery();
 ...
 private:
  ...
  gc_ptr(native_shared_ptr<native::CqQuery>) m_nativeptr;
};
}  // namespace Client
}  // namespace Geode
}  // namespace Apache
