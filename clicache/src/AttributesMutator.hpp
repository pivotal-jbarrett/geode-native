...
PUBLIC ref class AttributesMutator sealed {
 public:
  ...
  /// </param>
  void SetCacheListener(gc_ptr(ICacheListener<TKey, TValue>) cacheListener);
  ...
  /// </param>
  void SetCacheListener(gc_ptr(String) libPath, gc_ptr(String) factoryFunctionName);
  ...
  /// </param>
  void SetCacheLoader(gc_ptr(ICacheLoader<TKey, TValue>) cacheLoader);
  ...
  /// </param>
  void SetCacheLoader(gc_ptr(String) libPath, gc_ptr(String) factoryFunctionName);
  ...
  /// </param>
  void SetCacheWriter(gc_ptr(ICacheWriter<TKey, TValue>) cacheWriter);
 ...
 private:
  ...
  gc_ptr(native_shared_ptr<native::AttributesMutator>) m_nativeptr;
};
}  // namespace Client
}  // namespace Geode
}  // namespace Apache
