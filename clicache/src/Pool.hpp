...
PUBLIC ref class Pool sealed {
 public:
  ...
  /// </summary>
  property TimeSpan FreeConnectionTimeout { TimeSpan get(); }

  /// <summary>
  /// Returns the load conditioning interval of this pool.
  /// </summary>
  property TimeSpan LoadConditioningInterval { TimeSpan get(); }

  /// <summary>
  /// Returns the socket buffer size of this pool.
  /// </summary>
  property Int32 SocketBufferSize { Int32 get(); }

  /// <summary>
  /// Returns the read timeout of this pool.
  /// </summary>
  property TimeSpan ReadTimeout { TimeSpan get(); }

  /// <summary>
  /// Get the host name for the pool's SniProxy.
  /// </summary>
  property gc_ptr(String) SniProxyHost { gc_ptr(String) get(); }

  /// <summary>
  /// Get the host port for the pool's SniProxy.
  /// </summary>
  property Int32 SniProxyPort { Int32 get(); }

  /// <summary>
  /// Get the minimum connections for this pool.
  /// </summary>
  property Int32 MinConnections { Int32 get(); }

  /// <summary>
  /// Get the maximum connections for this pool.
  /// </summary>
  property Int32 MaxConnections { Int32 get(); }

  /// <summary>
  /// Get the Idle connection timeout for this pool.
  /// </summary>
  property TimeSpan IdleTimeout { TimeSpan get(); }
  ...
  /// </summary>
  property TimeSpan UpdateLocatorListInterval { TimeSpan get(); }

  /// <summary>
  /// Get the statistic interval for this pool.
  /// </summary>
  property TimeSpan StatisticInterval { TimeSpan get(); }

  /// <summary>
  /// Get the retry attempts for this pool.
  /// </summary>
  property Int32 RetryAttempts { Int32 get(); }

  /// <summary>
  /// Returns the true if a server-to-client subscriptions are enabled on this pool.
  /// </summary>
  property Boolean SubscriptionEnabled { Boolean get(); }

  /// <summary>
  /// Returns the true if a pr-single-hop is set to true on this pool.
  /// </summary>
  property Boolean PRSingleHopEnabled { Boolean get(); }

  /// <summary>
  /// Returns the subscription redundancy level of this pool.
  /// </summary>
  property Int32 SubscriptionRedundancy { Int32 get(); }

  /// <summary>
  /// Returns the subscription message tracking timeout of this pool.
  /// </summary>
  property TimeSpan SubscriptionMessageTrackingTimeout { TimeSpan get(); }

  /// <summary>
  /// Returns the subscription ack interval of this pool.
  /// </summary>
  property TimeSpan SubscriptionAckInterval { TimeSpan get(); }

  /// <summary>
  /// Returns the server group of this pool.
  /// </summary>
  property gc_ptr(String) ServerGroup { gc_ptr(String) get(); }
  ...
  /// </summary>
  property Boolean ThreadLocalConnections { Boolean get(); }

  /// <summary>
  /// Returns <code>true</code> if multiuser authentication is enabled on this pool.
  /// <summary>
  property bool MultiuserAuthentication { bool get(); }
  /// <summary>
  ...
  /// destroyed.
  /// </summary>
  property Boolean Destroyed { Boolean get(); }
  ...
  /// </remarks>
  gc_ptr(QueryService) GetQueryService();
  ...
  std::shared_ptr<native::Pool> GetNative() { return m_nativeptr->get_shared_ptr(); }
 ...
 private:
  ...
  gc_ptr(native_shared_ptr<native::Pool>) m_nativeptr;
};
}  // namespace Client
}  // namespace Geode
}  // namespace Apache
