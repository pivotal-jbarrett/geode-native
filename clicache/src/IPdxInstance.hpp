...
PUBLIC interface class IPdxInstance : public IDisposable {
 public:
  ...
  ///< returns> <code>true</code> if the named field exists and was marked as an identify field; otherwise
  ...
  gc_ptr(Object) GetField(gc_ptr(String) fieldName);
  ...
  bool Equals(gc_ptr(Object) other);
  ...
  gc_ptr(IWritablePdxInstance) CreateWriter();
};
}  // namespace Client
}  // namespace Geode
}  // namespace Apache
