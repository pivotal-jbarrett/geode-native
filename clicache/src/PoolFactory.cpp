...
gc_ptr(PoolFactory) PoolFactory::SetFreeConnectionTimeout(TimeSpan connectionTimeout) {
...
gc_ptr(PoolFactory) PoolFactory::SetLoadConditioningInterval(TimeSpan loadConditioningInterval) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(PoolFactory) PoolFactory::SetSocketBufferSize(Int32 bufferSize) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(PoolFactory) PoolFactory::SetReadTimeout(TimeSpan timeout) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(PoolFactory) PoolFactory::SetMinConnections(Int32 minConnections) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(PoolFactory) PoolFactory::SetMaxConnections(Int32 maxConnections) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(PoolFactory) PoolFactory::SetIdleTimeout(TimeSpan idleTimeout) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(PoolFactory) PoolFactory::SetRetryAttempts(Int32 retryAttempts) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(PoolFactory) PoolFactory::SetPingInterval(TimeSpan pingInterval) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(PoolFactory) PoolFactory::SetUpdateLocatorListInterval(TimeSpan updateLocatorListInterval) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(PoolFactory) PoolFactory::SetStatisticInterval(TimeSpan statisticInterval) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(PoolFactory) PoolFactory::SetServerGroup(gc_ptr(String) group) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(PoolFactory) PoolFactory::AddLocator(gc_ptr(String) host, Int32 port) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(PoolFactory) PoolFactory::AddServer(gc_ptr(String) host, Int32 port) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(PoolFactory) PoolFactory::SetSniProxy(gc_ptr(String) hostname, Int32 port) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(PoolFactory) PoolFactory::SetSubscriptionEnabled(Boolean enabled) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(PoolFactory) PoolFactory::SetPRSingleHopEnabled(Boolean enabled) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(PoolFactory) PoolFactory::SetSubscriptionRedundancy(Int32 redundancy) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(PoolFactory) PoolFactory::SetSubscriptionMessageTrackingTimeout(TimeSpan messageTrackingTimeout) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(PoolFactory) PoolFactory::SetSubscriptionAckInterval(TimeSpan ackInterval) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(PoolFactory) PoolFactory::SetThreadLocalConnections(Boolean enabled) {
...
gc_ptr(PoolFactory) PoolFactory::SetMultiuserAuthentication(bool multiuserAuthentication) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(PoolFactory) PoolFactory::Reset() {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
...
gc_ptr(Pool) PoolFactory::Create(gc_ptr(String) name) {
  _GF_MG_EXCEPTION_TRY2 /* due to auto replace */
