...
PUBLIC ref class DiskPolicy STATICCLASS {
 public:
  ...
  /// </summary>
  inline static bool IsOverflow(DiskPolicyType type) { return (type == DiskPolicyType::Overflows); }

  /// <summary>
  /// True if the current policy is <c>None</c>.
  /// </summary>
  inline static bool IsNone(DiskPolicyType type) { return (type == DiskPolicyType::None); }
