...
PUBLIC interface class ICacheListener {
 public:
  ...
  void AfterCreate(gc_ptr(EntryEvent<TKey, TValue>) ev);
  ...
  /// </param>
  /// <seealso cref="Region.Put" />
  void AfterUpdate(gc_ptr(EntryEvent<TKey, TValue>) ev);
  ...
  /// </param>
  void AfterInvalidate(gc_ptr(EntryEvent<TKey, TValue>) ev);
  ...
  void AfterDestroy(gc_ptr(EntryEvent<TKey, TValue>) ev);

  /// <summary>
  /// Handles the event of a region being cleared.
  /// </summary>
  void AfterRegionClear(gc_ptr(RegionEvent<TKey, TValue>) ev);
  ...
  void AfterRegionInvalidate(gc_ptr(RegionEvent<TKey, TValue>) ev);
  ...
  void AfterRegionDestroy(gc_ptr(RegionEvent<TKey, TValue>) ev);
  ...
  void AfterRegionLive(gc_ptr(RegionEvent<TKey, TValue>) ev);
  ...
  /// <seealso cref="Region.DestroyRegion" />
  void Close(gc_ptr(IRegion<TKey, TValue>) region);
  ...
  ///</remark>
  ///< param>
  /// region gc_ptr(Region) denotes the assosiated region.
  ///</param>
  void AfterRegionDisconnected(gc_ptr(IRegion<TKey, TValue>) region);
};
}  // namespace Client
}  // namespace Geode
}  // namespace Apache
