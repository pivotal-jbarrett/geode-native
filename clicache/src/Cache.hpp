...
GENERIC(class TPropKey, class TPropValue) ref class Properties;
...
/// </remarks>
public
ref class Cache sealed : public IGeodeCache {
 public:
  /// <summary>
  ...
  /// are attached with this instance. Get region from RegionService instance of Cache.<see
  /// cref="Cache.CreateAuthenticatedView(std::shared_ptr<PropertiesPtr>)" />.
  /// </remarks>
