...
ref class PdxInstanceFactoryImpl : IPdxInstanceFactory {
 ...
 public:
  ...
  /// </summary>
  virtual gc_ptr(IPdxInstance) Create();
  ...
  /// </summary>
  virtual gc_ptr(IPdxInstanceFactory) WriteChar(gc_ptr(String) fieldName, Char value);
  ...
  /// @throws PdxSerializationException if serialization of the field fails.
  /// </summary>
  virtual gc_ptr(IPdxInstanceFactory) WriteBoolean(gc_ptr(String) fieldName, Boolean value);
  ...
  /// @throws PdxSerializationException if serialization of the field fails.
  /// </summary>
  virtual gc_ptr(IPdxInstanceFactory) WriteByte(gc_ptr(String) fieldName, SByte value);
  ...
  /// @throws PdxSerializationException if serialization of the field fails.
  /// </summary>
  virtual gc_ptr(IPdxInstanceFactory) WriteShort(gc_ptr(String) fieldName, Int16 value);
  ...
  /// @throws PdxSerializationException if serialization of the field fails.
  /// </summary>
  virtual gc_ptr(IPdxInstanceFactory) WriteInt(gc_ptr(String) fieldName, Int32 value);
  ...
  /// @throws PdxSerializationException if serialization of the field fails.
  /// </summary>
  virtual gc_ptr(IPdxInstanceFactory) WriteLong(gc_ptr(String) fieldName, Int64 value);
  ...
  /// @throws PdxSerializationException if serialization of the field fails.
  /// </summary>
  virtual gc_ptr(IPdxInstanceFactory) WriteFloat(gc_ptr(String) fieldName, float value);
  ...
  /// @throws PdxSerializationException if serialization of the field fails.
  /// </summary>
  virtual gc_ptr(IPdxInstanceFactory) WriteDouble(gc_ptr(String) fieldName, double value);
  ...
  /// @throws PdxSerializationException if serialization of the field fails.
  /// </summary>
  virtual gc_ptr(IPdxInstanceFactory) WriteDate(gc_ptr(String) fieldName, System::DateTime value);
  ...
  /// @throws PdxSerializationException if serialization of the field fails.
  /// </summary>
  virtual gc_ptr(IPdxInstanceFactory) WriteString(gc_ptr(String) fieldName, gc_ptr(String) value);
  ...
  /// @throws PdxSerializationException if serialization of the field fails.
  /// </summary>
  virtual gc_ptr(IPdxInstanceFactory) WriteObject(gc_ptr(String) fieldName, gc_ptr(Object) value);
  ...
  /// @throws PdxSerializationException if serialization of the field fails.
  /// </summary>
  virtual gc_ptr(IPdxInstanceFactory) WriteCharArray(gc_ptr(String) fieldName, gc_ptr(array<Char>) value);
  ...
  /// @throws PdxSerializationException if serialization of the field fails.
  /// </summary>
  virtual gc_ptr(IPdxInstanceFactory) WriteByteArray(gc_ptr(String) fieldName, gc_ptr(array<Byte>) value);
  ...
  /// @throws PdxSerializationException if serialization of the field fails.
  /// </summary>
  virtual gc_ptr(IPdxInstanceFactory) WriteShortArray(gc_ptr(String) fieldName, gc_ptr(array<Int16>) value);
  ...
  /// @throws PdxSerializationException if serialization of the field fails.
  /// </summary>
  virtual gc_ptr(IPdxInstanceFactory) WriteIntArray(gc_ptr(String) fieldName, gc_ptr(array<Int32>) value);
  ...
  /// @throws PdxSerializationException if serialization of the field fails.
  /// </summary>
  virtual gc_ptr(IPdxInstanceFactory) WriteLongArray(gc_ptr(String) fieldName, gc_ptr(array<Int64>) value);
  ...
  /// @throws PdxSerializationException if serialization of the field fails.
  /// </summary>
  virtual gc_ptr(IPdxInstanceFactory) WriteFloatArray(gc_ptr(String) fieldName, gc_ptr(array<float>) value);
  ...
  /// For how each element of the array is a mapped to .NET see {@link #writeObject(String, Object, boolean)
  /// writeObject}. Note that this call may serialize elements that are not compatible with non-java languages. To
  /// ensure that only portable objects are serialized use {@link #writeObjectArray(String, Object[], boolean)}.
  /// @param fieldName the name of the field to write
  /// @param value the value of the field to write
  /// @return this PdxInstanceFactory
  /// @throws PdxFieldAlreadyExistsException if the named field has already been written
  ...
  /// If it can not find a specific match to a writeXXX method it will call {@link #writeObject(String, Object)
  /// writeObject}. This method may serialize objects that are not portable to non-java languages. To ensure that only
  /// objects that are portable to non-java languages are serialized use {@link #writeField(String, Object, Class,
  /// boolean)} instead. <p>The fieldTypes that map to a specific method are: <ul> <li>boolean.class: {@link
  /// #writeBoolean} <li>byte.class: {@link #writeByte} <li>char.class: {@link #writeChar} <li>short.class: {@link
  /// #writeShort} <li>int.class: {@link #writeInt} <li>long.class: {@link #writeLong} <li>float.class: {@link
  /// #writeFloat} <li>double.class: {@link #writeDouble} <li>String.class: {@link #writeString} <li>Date.class: {@link
  /// #writeDate} <li>boolean[].class: {@link #writeBooleanArray} <li>byte[].class: {@link #writeByteArray}
  ...
  /// </ul>
  /// Note that the object form of primitives, for example Integer.class and Long.class, map to {@link
  /// #writeObject(String, Object) writeObject}.
  /// @param fieldName the name of the field to write
  ...
  /// </summary>
  virtual gc_ptr(IPdxInstanceFactory) MarkIdentityField(gc_ptr(String) fieldName);
};
}  // namespace Internal
}  // namespace Client
}  // namespace Geode
