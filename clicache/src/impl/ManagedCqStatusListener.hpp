...
class ManagedCqStatusListenerGeneric : public apache::geode::client::CqStatusListener {
 public:
  ...
  /// </summary>
  inline gc_ptr(Apache::Geode::Client::ICqStatusListener<Object ^, Object ^>) ptr() const { return m_managedptr; }

  inline void setptr(gc_ptr(Apache::Geode::Client::ICqStatusListener<Object ^, Object ^>) managedptr) {
 ...
 private:
  ...
  /// </summary>
  gcroot<gc_ptr(Apache::Geode::Client::ICqStatusListener<Object ^, Object ^>)> m_managedptr;
