...
/// </summary>
class ManagedCqStatusListenerGeneric : public apache::geode::client::CqStatusListener {
 public:
  /// <summary>
  ...
  /// The user object.
  /// </param>
  inline ManagedCqStatusListenerGeneric(gc_ptr(Object) userptr) : m_userptr(userptr) {}
  ...
  /// </summary>
  inline gc_ptr(Apache::Geode::Client::ICqStatusListener<gc_ptr(Object), gc_ptr(Object)>) ptr() const {
    return m_managedptr;
  }

  inline void setptr(gc_ptr(Apache::Geode::Client::ICqStatusListener<gc_ptr(Object), gc_ptr(Object)>) managedptr) {
 ...
 private:
  ...
  /// </summary>
  gcroot<gc_ptr(Apache::Geode::Client::ICqStatusListener<gc_ptr(Object), gc_ptr(Object)>)> m_managedptr;
