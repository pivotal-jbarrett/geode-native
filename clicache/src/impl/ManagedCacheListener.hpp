...
/// </summary>
class ManagedCacheListenerGeneric : public apache::geode::client::CacheListener {
 public:
  /// <summary>
  ...
  inline ManagedCacheListenerGeneric(
      /*gc_ptr(Apache::Geode::Client::ICacheListener) managedptr,*/ gc_ptr(Object) userptr)
  ...
  /// </exception>
  static apache::geode::client::CacheListener* create(const char* assemblyPath, const char* factoryFunctionName);
