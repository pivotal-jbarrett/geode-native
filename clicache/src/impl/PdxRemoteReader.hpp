...
ref class PdxRemoteReader : public PdxLocalReader {
 ...
 public:
  PdxRemoteReader(gc_ptr(DataInput) dataInput, gc_ptr(PdxType) remoteType, Int32 pdxLen)
  ...
  /// </summary>
  /// <param name="fieldName">The name of a member field whose value to read.</param>
  virtual Boolean ReadBoolean(gc_ptr(String) fieldName) override;
  ...
  /// </summary>
  /// <param name="fieldName">The name of a member field whose value to read.</param>
  virtual void ReadCollection(gc_ptr(String) fieldName, gc_ptr(System::Collections::IList) collection) override;
