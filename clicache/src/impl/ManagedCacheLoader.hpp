...
/// </summary>
class ManagedCacheLoaderGeneric : public apache::geode::client::CacheLoader {
 public:
  /// <summary>
  ...
  /// </exception>
  static apache::geode::client::CacheLoader* create(const char* assemblyPath, const char* factoryFunctionName);
  ...
  virtual std::shared_ptr<Cacheable> load(Region& region, const std::shared_ptr<CacheableKey>& key,
  ...
  /// </summary>
  inline gc_ptr(Apache::Geode::Client::ICacheLoader) ptr( ) const
  {
  return m_managedptr;
  }
  */

  inline void setptr(gc_ptr(Apache::Geode::Client::ICacheLoaderProxy) managedptr) { m_managedptr = managedptr; }
 ...
 private:
  ...
  /// </summary>
  gcroot<gc_ptr(Apache::Geode::Client::ICacheLoaderProxy)> m_managedptr;
