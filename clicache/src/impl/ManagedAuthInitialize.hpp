...
/// </summary>
class ManagedAuthInitializeGeneric : public apache::geode::client::AuthInitialize {
 public:
  /// <summary>
  ...
  /// The managed object.
  /// </param>
  inline ManagedAuthInitializeGeneric(gc_ptr(Apache::Geode::Client::IAuthInitialize) managedptr)
      : m_managedptr(managedptr) {
    m_getCredentials = gcnew Apache::Geode::Client::IAuthInitialize::GetCredentialsDelegate(
        managedptr, &Apache::Geode::Client::IAuthInitialize::GetCredentials);
    m_close = gcnew Apache::Geode::Client::IAuthInitialize::CloseDelegate(
        managedptr, &Apache::Geode::Client::IAuthInitialize::Close);
  }
  ...
  /// </summary>
  inline gc_ptr(Apache::Geode::Client::IAuthInitialize) ptr() const { return m_managedptr; }
 ...
 private:
  ...
  /// </summary>
  gcroot<gc_ptr(Apache::Geode::Client::IAuthInitialize)> m_managedptr;
  gcroot<gc_ptr(Apache::Geode::Client::IAuthInitialize::GetCredentialsDelegate)> m_getCredentials;
  gcroot<gc_ptr(Apache::Geode::Client::IAuthInitialize::CloseDelegate)> m_close;
