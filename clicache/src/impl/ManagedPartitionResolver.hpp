...
/// </summary>
class ManagedPartitionResolverGeneric : public PartitionResolver {
 public:
  /// <summary>
  ...
  /// The managed object.
  /// </param>
  inline ManagedPartitionResolverGeneric(gc_ptr(Object) userptr) : m_userptr(userptr) {}
 ...
 private:
  ...
  /// </summary>
  gcroot<gc_ptr(Apache::Geode::Client::IPartitionResolverProxy)> m_managedptr;
