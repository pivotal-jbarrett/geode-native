...
namespace Internal {
private
ref class PdxFieldType : IDataSerializableInternal {
 private:
 ...
 public:
  PdxFieldType(gc_ptr(String) fieldName, gc_ptr(String) className, Byte typeId, Int32 sequenceId,
               bool isVariableLengthType, Int32 fixedSize, Int32 varLenFieldIdx) {
    m_cachedHashcode = 0;
  ...
  PdxFieldType() { m_cachedHashcode = 0; }

  property Int32 SequenceId { Int32 get(); }

  property gc_ptr(String) FieldName { gc_ptr(String) get(); }

  property gc_ptr(String) ClassName { gc_ptr(String) get(); }

  property Byte TypeId { Byte get(); }

  property bool IsVariableLengthType { bool get(); }
  ...
  property Int32 Size { Int32 get(); }

  property Int32 VarLenFieldIdx { Int32 get(); }
  ...
  virtual bool Equals(gc_ptr(Object) otherObj) override;
  ...
  virtual gc_ptr(String) ToString() override {
    return "PdxFieldName:" + m_fieldName + ", TypeId: " + m_typeId + ", VarLenFieldIdx:" + m_varLenFieldIdx +
