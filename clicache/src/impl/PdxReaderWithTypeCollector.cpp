...
SByte PdxReaderWithTypeCollector::ReadByte(gc_ptr(String) fieldName) {
...
SByte PdxReaderWithTypeCollector::ReadSByte(gc_ptr(String) fieldName) {
  checkType(fieldName, PdxFieldTypes::BYTE, "byte");
  m_newPdxType->AddFixedLengthTypeField(fieldName, "byte", PdxFieldTypes::BYTE, native::PdxTypes::BYTE_SIZE);
  int position = m_pdxType->GetFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
  if (position != -1) {
...
Boolean PdxReaderWithTypeCollector::ReadBoolean(gc_ptr(String) fieldName) {
...
Char PdxReaderWithTypeCollector::ReadChar(gc_ptr(String) fieldName) {
...
System::UInt16 PdxReaderWithTypeCollector::ReadUInt16(gc_ptr(String) fieldName) {
...
System::UInt32 PdxReaderWithTypeCollector::ReadUInt32(gc_ptr(String) fieldName) {
...
System::UInt64 PdxReaderWithTypeCollector::ReadUInt64(gc_ptr(String) fieldName) {
...
short PdxReaderWithTypeCollector::ReadShort(gc_ptr(String) fieldName) {
  checkType(fieldName, PdxFieldTypes::SHORT, "short");
  m_newPdxType->AddFixedLengthTypeField(fieldName, "short", PdxFieldTypes::SHORT, native::PdxTypes::SHORT_SIZE);
  int position = m_pdxType->GetFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
  if (position != -1) {
...
Int32 PdxReaderWithTypeCollector::ReadInt(gc_ptr(String) fieldName) {
  checkType(fieldName, PdxFieldTypes::INT, "int");
  m_newPdxType->AddFixedLengthTypeField(fieldName, "int", PdxFieldTypes::INT, native::PdxTypes::INTEGER_SIZE);
  int position = m_pdxType->GetFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
  if (position != -1) {
...
Int64 PdxReaderWithTypeCollector::ReadLong(gc_ptr(String) fieldName) {
  checkType(fieldName, PdxFieldTypes::LONG, "long");
  m_newPdxType->AddFixedLengthTypeField(fieldName, "long", PdxFieldTypes::LONG, native::PdxTypes::LONG_SIZE);
  int position = m_pdxType->GetFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
  if (position != -1) {
...
float PdxReaderWithTypeCollector::ReadFloat(gc_ptr(String) fieldName) {
...
double PdxReaderWithTypeCollector::ReadDouble(gc_ptr(String) fieldName) {
...
gc_ptr(String) PdxReaderWithTypeCollector::ReadString(gc_ptr(String) fieldName) {
...
gc_ptr(String) PdxReaderWithTypeCollector::ReadUTFHuge(gc_ptr(String) fieldName) {
  checkType(fieldName, PdxFieldTypes::STRING, "String");
  m_newPdxType->AddVariableLengthTypeField(fieldName, "String", PdxFieldTypes::STRING);
  int position = m_pdxType->GetFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
  if (position != -1) {
...
gc_ptr(String) PdxReaderWithTypeCollector::ReadASCIIHuge(gc_ptr(String) fieldName) {
  checkType(fieldName, PdxFieldTypes::STRING, "String");
  m_newPdxType->AddVariableLengthTypeField(fieldName, "String", PdxFieldTypes::STRING);
  int position = m_pdxType->GetFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
  if (position != -1) {
...
gc_ptr(Object) PdxReaderWithTypeCollector::ReadObject(gc_ptr(String) fieldName) {
...
System::DateTime PdxReaderWithTypeCollector::ReadDate(gc_ptr(String) fieldName) {
...
gc_ptr(array<bool>) PdxReaderWithTypeCollector::ReadBooleanArray(gc_ptr(String) fieldName) {
...
gc_ptr(array<Char>) PdxReaderWithTypeCollector::ReadCharArray(gc_ptr(String) fieldName) {
...
gc_ptr(array<Byte>) PdxReaderWithTypeCollector::ReadByteArray(gc_ptr(String) fieldName) {
...
gc_ptr(array<SByte>) PdxReaderWithTypeCollector::ReadSByteArray(gc_ptr(String) fieldName) {
  checkType(fieldName, PdxFieldTypes::BYTE_ARRAY, "byte[]");
  m_newPdxType->AddVariableLengthTypeField(fieldName, "byte[]", PdxFieldTypes::BYTE_ARRAY);
  int position = m_pdxType->GetFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
  if (position != -1) {
...
gc_ptr(array<short>) PdxReaderWithTypeCollector::ReadShortArray(gc_ptr(String) fieldName) {
...
gc_ptr(array<System::UInt16>) PdxReaderWithTypeCollector::ReadUnsignedShortArray(gc_ptr(String) fieldName) {
  checkType(fieldName, PdxFieldTypes::SHORT_ARRAY, "short[]");
  m_newPdxType->AddVariableLengthTypeField(fieldName, "short[]", PdxFieldTypes::SHORT_ARRAY);
  int position = m_pdxType->GetFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
  if (position != -1) {
...
gc_ptr(array<System::Int32>) PdxReaderWithTypeCollector::ReadIntArray(gc_ptr(String) fieldName) {
...
gc_ptr(array<System::UInt32>) PdxReaderWithTypeCollector::ReadUnsignedIntArray(gc_ptr(String) fieldName) {
  checkType(fieldName, PdxFieldTypes::INT_ARRAY, "int[]");
  m_newPdxType->AddVariableLengthTypeField(fieldName, "int[]", PdxFieldTypes::INT_ARRAY);
  int position = m_pdxType->GetFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
  if (position != -1) {
...
gc_ptr(array<Int64>) PdxReaderWithTypeCollector::ReadLongArray(gc_ptr(String) fieldName) {
...
gc_ptr(array<System::UInt64>) PdxReaderWithTypeCollector::ReadUnsignedLongArray(gc_ptr(String) fieldName) {
  checkType(fieldName, PdxFieldTypes::LONG_ARRAY, "long[]");
  m_newPdxType->AddVariableLengthTypeField(fieldName, "long[]", PdxFieldTypes::LONG_ARRAY);
  int position = m_pdxType->GetFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
  if (position != -1) {
...
gc_ptr(array<float>) PdxReaderWithTypeCollector::ReadFloatArray(gc_ptr(String) fieldName) {
...
gc_ptr(array<double>) PdxReaderWithTypeCollector::ReadDoubleArray(gc_ptr(String) fieldName) {
...
array<gc_ptr(array<Byte>)> ^ PdxReaderWithTypeCollector::ReadArrayOfByteArrays(gc_ptr(String) fieldName) {
