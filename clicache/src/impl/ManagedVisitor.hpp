...
/// </summary>
class ManagedVisitorGeneric : public apache::geode::client::Properties::Visitor {
 public:
  /// <summary>
  /// Create a <c>apache::geode::client::Properties::Visitor</c> from the given managed
  /// <c>PropertyVisitor</c> delegate.
  /// </summary>
  inline ManagedVisitorGeneric(gc_ptr(Object) visitorFunc) : m_managedptr(visitorFunc) {}
  ...
  void setptr(gc_ptr(Apache::Geode::Client::PropertyVisitor) visitor) { m_visitor = visitor; }
 ...
 private:
  ...
  gcroot<gc_ptr(Object)> m_managedptr;

  gcroot<gc_ptr(Apache::Geode::Client::PropertyVisitor)> m_visitor;
