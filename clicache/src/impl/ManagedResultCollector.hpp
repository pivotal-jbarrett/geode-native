...
/// </summary>
class ManagedResultCollectorGeneric : public apache::geode::client::ResultCollector {
 public:
  /// <summary>
  ...
  /// The managed object.
  /// </param>
  inline ManagedResultCollectorGeneric(gc_ptr(Apache::Geode::Client::ResultCollectorG) userptr)
  ...
  /// </exception>
  static apache::geode::client::ResultCollector* create(const char* assemblyPath, const char* factoryFunctionName);
  ...
  std::shared_ptr<CacheableVector> getResult(
      std::chrono::milliseconds timeout = native::DEFAULT_QUERY_RESPONSE_TIMEOUT) override;
  ...
  /// </summary>
  inline gc_ptr(Apache::Geode::Client::ResultCollectorG) ptr() const { return m_managedptr; }
 ...
 private:
  ...
  /// </summary>
  gcroot<gc_ptr(Apache::Geode::Client::ResultCollectorG)> m_managedptr;
  // gc_ptr(Apache::Geode::Client::IResultCollector) m_managedptr;
