...
gc_ptr(Apache::Geode::Client::TransactionId) CacheTransactionManager::Suspend() {
  _GF_MG_EXCEPTION_TRY2
...
gc_ptr(Apache::Geode::Client::TransactionId) CacheTransactionManager::TransactionId::get() {
  _GF_MG_EXCEPTION_TRY2
...
void CacheTransactionManager::Resume(gc_ptr(Apache::Geode::Client::TransactionId) transactionId) {
  _GF_MG_EXCEPTION_TRY2
...
bool CacheTransactionManager::IsSuspended(gc_ptr(Apache::Geode::Client::TransactionId) transactionId) {
  _GF_MG_EXCEPTION_TRY2
...
bool CacheTransactionManager::Exists(gc_ptr(Apache::Geode::Client::TransactionId) transactionId) {
  _GF_MG_EXCEPTION_TRY2
...
gc_ptr(ITransactionWriter<TKey, TValue>) CacheTransactionManager::GetWriter() {
  _GF_MG_EXCEPTION_TRY2
    ...
    if (twg != nullptr) {
      return (gc_ptr(ITransactionWriter<TKey, TValue>))twg->userptr();
    }
...
GENERIC(class TKey, class TValue)
void CacheTransactionManager::SetWriter(gc_ptr(ITransactionWriter<TKey, TValue>) transactionWriter) {
  _GF_MG_EXCEPTION_TRY2
    ...
    if (transactionWriter != nullptr) {
      gc_ptr(TransactionWriterGeneric<TKey, TValue>) twg = gcnew TransactionWriterGeneric<TKey, TValue>();
...
GENERIC(class TKey, class TValue)
void CacheTransactionManager::AddListener(gc_ptr(ITransactionListener<TKey, TValue>) transactionListener) {
  _GF_MG_EXCEPTION_TRY2
    ...
    if (transactionListener != nullptr) {
      gc_ptr(TransactionListenerGeneric<TKey, TValue>) twg = gcnew TransactionListenerGeneric<TKey, TValue>();
...
GENERIC(class TKey, class TValue)
void CacheTransactionManager::RemoveListener(gc_ptr(ITransactionListener<TKey, TValue>) transactionListener) {
  _GF_MG_EXCEPTION_TRY2
