...
PUBLIC ref class native_conditional_shared_ptr sealed {
 ...
 public:
  ...
  ~native_conditional_shared_ptr() { native_conditional_shared_ptr::!native_conditional_shared_ptr(); }

  !native_conditional_shared_ptr() { delete owned_ptr; }

  inline _T* get() { return __nullptr == owned_ptr ? unowned_ptr : owned_ptr->get(); }

  inline std::shared_ptr<_T> get_conditional_shared_ptr() { return owned_ptr ? *owned_ptr : nullptr; }
};
}  // namespace Client
}  // namespace Geode
}  // namespace Apache