...
ref class CacheableBuiltinKey : public IDataSerializablePrimitive, public CacheableKey {
 public:
  /// <summary>
  ...
  /// </summary>
  gc_ptr(String) ToString() override {
    try {
  ...
  /// native object.
  /// </summary>
  virtual bool Equals(gc_ptr(ICacheableKey) other) override {
    if (auto o = dynamic_cast<gc_ptr(CacheableBuiltinKey)>(other)) {
      try {
        return GetNative()->operator==(*dynamic_cast<TNative*>(o->m_nativeptr->get()));
      } finally {
        GC::KeepAlive(m_nativeptr);
  ...
  /// native object.
  /// </summary>
  virtual bool Equals(gc_ptr(Object) obj) override { return Equals(dynamic_cast<gc_ptr(CacheableBuiltinKey)>(obj)); }
  ...
  virtual void ToData(gc_ptr(DataOutput) dataOutput) {
    try {
  ...
  virtual void FromData(gc_ptr(DataInput) dataInput) {
    try {
 ...
 protected:
  ...
  inline CacheableBuiltinKey(std::shared_ptr<native::Serializable> nativeptr) : CacheableKey(nativeptr) {}

 private:
  inline TNative* GetNative() { return dynamic_cast<TNative*>(m_nativeptr->get()); }
};
...
ref class CacheableBuiltinArray : public IDataSerializablePrimitive {
 public:
  ...
  virtual void ToData(gc_ptr(DataOutput) output) { output->WriteObject(m_value); }

  virtual void FromData(gc_ptr(DataInput) input) { input->ReadObject(m_value); }
  ...
  /// </summary>
  property gc_ptr(array<TManaged>) Value {
    inline gc_ptr(array<TManaged>) get() { return m_value; }
  }
 ...
 protected:
  ...
  inline CacheableBuiltinArray(std::shared_ptr<native::Serializable> nptr) {
    ...
    if (len > 0) {
      gc_ptr(array<TManaged>) buffer = gcnew array<TManaged>(len);
      pin_ptr<TManaged> pin_buffer = &buffer[0];

      memcpy((void*)pin_buffer, nativeptr->value().data(), len * sizeof(TManaged));
      m_value = buffer;
    }
  }
  ...
  CacheableBuiltinArray(gc_ptr(array<TManaged>) buffer) {
    m_value = buffer;
  ...
  CacheableBuiltinArray(gc_ptr(array<TManaged>) buffer, System::Int32 length) {
    // TODO:
...
/// </summary>
_GFCLI_CACHEABLE_KEY_DEF_NEW(native::CacheableBoolean, CacheableBoolean, bool);

/// <summary>
/// An immutable wrapper for bytes that can serve
/// as a distributable key object for caching.
/// </summary>
_GFCLI_CACHEABLE_KEY_DEF_NEW(native::CacheableByte, CacheableByte, Byte);

/// <summary>
/// An immutable wrapper for 16-bit characters that can serve
/// as a distributable key object for caching.
/// </summary>
_GFCLI_CACHEABLE_KEY_DEF_NEW(native::CacheableCharacter, CacheableCharacter, Char);

/// <summary>
/// An immutable wrapper for doubles that can serve
/// as a distributable key object for caching.
/// </summary>
_GFCLI_CACHEABLE_KEY_DEF_NEW(native::CacheableDouble, CacheableDouble, Double);

/// <summary>
/// An immutable wrapper for floats that can serve
/// as a distributable key object for caching.
/// </summary>
_GFCLI_CACHEABLE_KEY_DEF_NEW(native::CacheableFloat, CacheableFloat, Single);

/// <summary>
/// An immutable wrapper for 16-bit integers that can serve
/// as a distributable key object for caching.
/// </summary>
_GFCLI_CACHEABLE_KEY_DEF_NEW(native::CacheableInt16, CacheableInt16, System::Int16);

/// <summary>
/// An immutable wrapper for 32-bit integers that can serve
/// as a distributable key object for caching.
/// </summary>
_GFCLI_CACHEABLE_KEY_DEF_NEW(native::CacheableInt32, CacheableInt32, System::Int32);

/// <summary>
/// An immutable wrapper for 64-bit integers that can serve
/// as a distributable key object for caching.
/// </summary>
_GFCLI_CACHEABLE_KEY_DEF_NEW(native::CacheableInt64, CacheableInt64, System::Int64);

// Built-in Cacheable array types

template <typename NativeArray, typename ManagedType, int8_t DsCode>
ref class CacheableArray : public CacheableBuiltinArray<NativeArray, NativeArray, ManagedType, DsCode> {
 public:
  /** <summary>
   ...
   */
  inline static gc_ptr(CacheableArray) Create(gc_ptr(array<ManagedType>) value) {
    return (value != nullptr /*&& value->Length > 0*/ ? gcnew CacheableArray(value) : nullptr);
  }
  /** <summary>
   *  Static function to create a new instance copying
   *  from the given array.
   ...
   *  <param name="value">the array to create the new instance</param>
   */
  inline CacheableArray(gc_ptr(array<ManagedType>) value) : CacheableBuiltinArray(value) {}
  /** <summary>
   * Allocates a new instance copying given length from the
   * start of given array.
   *  </summary>
   ...
   *  <param name="value">the array to create the new instance</param>
   */
  inline CacheableArray(gc_ptr(array<ManagedType>) value, System::Int32 length)
      : CacheableBuiltinArray(value, length) {}
  inline CacheableArray(std::shared_ptr<native::Serializable> nativeptr) : CacheableBuiltinArray(nativeptr) {}
};
...
using CacheableBytes =
    CacheableArray<native::internal::CacheableArrayPrimitive<int8_t, native::internal::DSCode::CacheableBytes>, Byte,
...
using CacheableDoubleArray =
    CacheableArray<native::internal::CacheableArrayPrimitive<double, native::internal::DSCode::CacheableDoubleArray>,
...
using CacheableFloatArray =
    CacheableArray<native::internal::CacheableArrayPrimitive<float, native::internal::DSCode::CacheableFloatArray>,
...
using CacheableInt16Array =
    CacheableArray<native::internal::CacheableArrayPrimitive<int16_t, native::internal::DSCode::CacheableInt16Array>,
                   System::Int16, static_cast<int8_t>(DSCode::CacheableInt16Array)>;
...
using CacheableInt32Array =
    CacheableArray<native::internal::CacheableArrayPrimitive<int32_t, native::internal::DSCode::CacheableInt32Array>,
                   System::Int32, static_cast<int8_t>(DSCode::CacheableInt32Array)>;
...
using CacheableInt64Array =
    CacheableArray<native::internal::CacheableArrayPrimitive<int64_t, native::internal::DSCode::CacheableInt64Array>,
                   System::Int64, static_cast<int8_t>(DSCode::CacheableInt64Array)>;
...
/// </summary>
using BooleanArray =
    CacheableArray<native::internal::CacheableArrayPrimitive<bool, native::internal::DSCode::BooleanArray>, bool,
...
/// </summary>
using CharArray =
    CacheableArray<native::internal::CacheableArrayPrimitive<char16_t, native::internal::DSCode::CharArray>, Char,
