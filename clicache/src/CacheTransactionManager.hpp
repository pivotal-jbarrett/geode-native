...
PUBLIC ref class CacheTransactionManager sealed {
 public:
  ...
  gc_ptr(Apache::Geode::Client::TransactionId) Suspend();
  ...
  void Resume(gc_ptr(Apache::Geode::Client::TransactionId) transactionId);
  ...
  /// <see cref="TransactionId"/>
  bool IsSuspended(gc_ptr(Apache::Geode::Client::TransactionId) transactionId);
  ...
  bool TryResume(gc_ptr(Apache::Geode::Client::TransactionId) transactionId);
  ...
  /// <returns>true if the transaction was resumed, false otherwise</returns>
  bool TryResume(gc_ptr(Apache::Geode::Client::TransactionId) transactionId, TimeSpan waitTime);
  ...
  bool Exists(gc_ptr(Apache::Geode::Client::TransactionId) transactionId);
 ...
 private:
  ...
  inline CacheTransactionManager(native::CacheTransactionManager* nativeptr) : m_nativeptr(nativeptr) {}
