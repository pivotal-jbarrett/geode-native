...
ref class Log STATICCLASS {
 public:
  ...
  static void Init(LogLevel level, gc_ptr(String) logFileName);
  ...
  static void Init(LogLevel level, gc_ptr(String) logFileName, System::Int32 logFileLimit);
  ...
  /// </summary>
  static void Write(LogLevel level, gc_ptr(String) msg);

  /// <summary>
  /// Logs both a message and a thrown exception.
  /// </summary>
  static void LogThrow(LogLevel level, gc_ptr(String) msg, gc_ptr(System::Exception) ex);

  /// <summary>
  /// Logs both a message and a caught exception.
  /// </summary>
  static void LogCatch(LogLevel level, gc_ptr(String) msg, gc_ptr(System::Exception) ex);
