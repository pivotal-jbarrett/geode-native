...
PUBLIC interface class ISubscriptionService {
 public:
  ...
  void RegisterKeys(gc_ptr(System::Collections::Generic::ICollection<TKey>) keys);
  ...
  /// </exception>
  /// <exception cref="UnknownException">For other exceptions.</exception>
  void UnregisterKeys(gc_ptr(System::Collections::Generic::ICollection<TKey>) keys);
  ...
  /// </summary>
  gc_ptr(System::Collections::Generic::ICollection<TKey>) GetInterestList();
  ...
  /// </exception>
  /// <exception cref="UnknownException">For other exceptions.</exception>
  void RegisterRegex(gc_ptr(String) regex);
  ...
  /// </exception>
  /// <exception cref="UnknownException">For other exceptions.</exception>
  void RegisterRegex(gc_ptr(String) regex, bool isDurable);
  ...
  /// </exception>
  /// <exception cref="UnknownException">For other exceptions.</exception>
  void RegisterRegex(gc_ptr(String) regex, bool isDurable, bool getInitialValues);
  ...
  /// </exception>
  /// <exception cref="UnknownException">For other exceptions.</exception>
  void RegisterRegex(gc_ptr(String) regex, bool isDurable, bool getInitialValues, bool receiveValues);
  ...
  /// </exception>
  /// <exception cref="UnknownException">For other exceptions.</exception>
  void UnregisterRegex(gc_ptr(String) regex);
};
}  // namespace Client
}  // namespace Geode
}  // namespace Apache
