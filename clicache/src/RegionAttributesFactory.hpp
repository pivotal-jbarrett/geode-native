...
PUBLIC ref class RegionAttributesFactory sealed {
 public:
  ...
  inline RegionAttributesFactory<TKey, TValue>() {
    m_nativeptr =
        gcnew native_unique_ptr<native::RegionAttributesFactory>(std::make_unique<native::RegionAttributesFactory>());
  }
  ...
  /// </param>
  RegionAttributesFactory<TKey, TValue>(gc_ptr(RegionAttributes<TKey, TValue>) regionAttributes);
  ...
  /// </param>
  // GENERIC(class TKey, class TValue)
  gc_ptr(RegionAttributesFactory<TKey, TValue>) SetCacheLoader(gc_ptr(ICacheLoader<TKey, TValue>) cacheLoader);
  ...
  /// </param>
  // GENERIC(class TKey, class TValue)
  gc_ptr(RegionAttributesFactory<TKey, TValue>) SetCacheWriter(gc_ptr(ICacheWriter<TKey, TValue>) cacheWriter);
  ...
  // GENERIC(class TKey, class TValue)
  gc_ptr(RegionAttributesFactory<TKey, TValue>)
      SetCacheLoader(gc_ptr(String) libPath, gc_ptr(String) factoryFunctionName);
  ...
  // GENERIC(class TKey, class TValue)
  gc_ptr(RegionAttributesFactory<TKey, TValue>)
      SetCacheWriter(gc_ptr(String) libPath, gc_ptr(String) factoryFunctionName);
  ...
  // GENERIC(class TKey, class TValue)
  gc_ptr(RegionAttributesFactory<TKey, TValue>)
      SetCacheListener(gc_ptr(String) libPath, gc_ptr(String) factoryFunctionName);
  ...
  // GENERIC(class TKey, class TValue)
  gc_ptr(RegionAttributesFactory<TKey, TValue>)
      SetPartitionResolver(gc_ptr(String) libPath, gc_ptr(String) factoryFunctionName);
  ...
  /// </param>
  gc_ptr(RegionAttributesFactory<TKey, TValue>) SetEntryIdleTimeout(ExpirationAction action, TimeSpan idleTimeout);
  ...
  /// </param>
  gc_ptr(RegionAttributesFactory<TKey, TValue>) SetEntryTimeToLive(ExpirationAction action, TimeSpan timeToLive);
  ...
  /// </param>
  gc_ptr(RegionAttributesFactory<TKey, TValue>) SetRegionIdleTimeout(ExpirationAction action, TimeSpan idleTimeout);
  ...
  /// </param>
  gc_ptr(RegionAttributesFactory<TKey, TValue>) SetRegionTimeToLive(ExpirationAction action, TimeSpan timeToLive);
  ...
  /// </param>
  gc_ptr(RegionAttributesFactory<TKey, TValue>)
      SetPersistenceManager(gc_ptr(String) libPath, gc_ptr(String) factoryFunctionName);
  ...
  /// </param>
  gc_ptr(RegionAttributesFactory<TKey, TValue>) SetPoolName(gc_ptr(String) poolName);
  ...
  /// </exception>
  gc_ptr(RegionAttributesFactory<TKey, TValue>) SetInitialCapacity(System::Int32 initialCapacity);
  ...
  /// </exception>
  gc_ptr(RegionAttributesFactory<TKey, TValue>) SetLoadFactor(Single loadFactor);
  ...
  /// </exception>
  gc_ptr(RegionAttributesFactory<TKey, TValue>) SetConcurrencyLevel(System::Int32 concurrencyLevel);
  ...
  /// </param>
  gc_ptr(RegionAttributesFactory<TKey, TValue>) SetLruEntriesLimit(System::UInt32 entriesLimit);
  ...
  /// </param>
  gc_ptr(RegionAttributesFactory<TKey, TValue>) SetDiskPolicy(DiskPolicyType diskPolicy);
  ...
  /// </param>
  gc_ptr(RegionAttributesFactory<TKey, TValue>) SetCachingEnabled(bool cachingEnabled);
  /// <summary>
  ...
  /// </param>
  gc_ptr(RegionAttributesFactory<TKey, TValue>) SetCloningEnabled(bool cloningEnabled);
  ...
  /// </param>
  gc_ptr(RegionAttributesFactory<TKey, TValue>) SetConcurrencyChecksEnabled(bool concurrencyChecksEnabled);
  // FACTORY METHOD
  ...
  /// compatibility rules.
  /// </exception>
  gc_ptr(RegionAttributes<TKey, TValue>) Create();

 private:
  gc_ptr(native_unique_ptr<native::RegionAttributesFactory>) m_nativeptr;
};
}  // namespace Client
}  // namespace Geode
}  // namespace Apache
