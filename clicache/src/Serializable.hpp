...
/// </summary>
public
delegate gc_ptr(Apache::Geode::Client::ISerializable) TypeFactoryMethod();
/// <summary>
...
/// </remarks>
delegate gc_ptr(Apache::Geode::Client::ISerializable)
    DataSerializablePrimitiveWrapperDelegate(std::shared_ptr<native::Serializable> obj);
...
/// </summary>
public
delegate gc_ptr(Apache::Geode::Client::IPdxSerializable) PdxTypeFactoryMethod();

/// <summary>
/// This class wraps the native C++ <c>native::Serializable</c> objects
/// as managed <see cref="ISerializable" /> objects.
/// </summary>
PUBLIC ref class Serializable : public Apache::Geode::Client::ISerializable {
 public:
  /// <summary>
  ...
  static int GetEnumValue(gc_ptr(Internal::EnumInfo) ei, gc_ptr(Cache) cache);
  static gc_ptr(Internal::EnumInfo) GetEnum(int val, gc_ptr(Cache) cache);
  ...
  static gc_ptr(String) getString(std::shared_ptr<native::Serializable> nativeptr);

  static std::shared_ptr<native::CacheableString> GetCacheableString(gc_ptr(String) value);

  static gc_ptr(array<Byte>) getSByteArray(gc_ptr(array<SByte>) sArray);

  static gc_ptr(array<System::Int16>) getInt16Array(gc_ptr(array<System::UInt16>) sArray);

  static gc_ptr(array<System::Int32>) getInt32Array(gc_ptr(array<System::UInt32>) sArray);

  static gc_ptr(array<System::Int64>) getInt64Array(gc_ptr(array<System::UInt64>) sArray);

  /// <summary>
  /// Default constructor.
  /// </summary>
  inline Apache::Geode::Client::Serializable() : Serializable(__nullptr) {}
  ...
  GENERIC(class TKey)
  static std::shared_ptr<native::CacheableKey> GetUnmanagedValueGeneric(gc_ptr(Type) managedType, TKey key);
 ...
 protected:
  gc_ptr(native_shared_ptr<native::Serializable>) m_nativeptr;
};
}  // namespace Client
}  // namespace Geode
}  // namespace Apache
