...
PUBLIC ref class SystemProperties sealed {
 public:
  ...
  property TimeSpan StatisticsSampleInterval { TimeSpan get(); }

  /// <summary>
  /// True if statistics are enabled (archived).
  /// </summary>
  /// <returns>true if enabled</returns>
  property bool StatisticsEnabled { bool get(); }

  /// <summary>
  /// Returns the name of the statistics archive file.
  /// </summary>
  /// <returns>the filename</returns>
  property gc_ptr(String) StatisticsArchiveFile { gc_ptr(String) get(); }

  /// <summary>
  /// Returns the name of the message log file.
  /// </summary>
  /// <returns>the filename</returns>
  property gc_ptr(String) LogFileName { gc_ptr(String) get(); }

  /// <summary>
  /// Returns the message logging level.
  /// </summary>
  /// <returns>the log level</returns>
  property LogLevel GFLogLevel { LogLevel get(); }
  ...
  /// </summary>
  /// <returns>true if enabled</returns>
  property bool HeapLRULimitEnabled { bool get(); }
  ...
  property size_t HeapLRULimit { size_t get(); }
  ...
  property TimeSpan NotifyDupCheckLife { TimeSpan get(); }
  ...
  property gc_ptr(String) SSLKeystorePassword { gc_ptr(String) get(); }
  ...
  property gc_ptr(String) DurableClientId { gc_ptr(String) get(); }

  /// <summary>
  /// Returns the durable client's timeout.
  /// </summary>
  /// <returns>the durable client timeout</returns>
  property TimeSpan DurableTimeout { TimeSpan get(); }
  ...
  property TimeSpan ConnectTimeout { TimeSpan get(); }

  /// <summary>
  /// Returns the conflate event's option
  /// </summary>
  /// <returns>the conflate event option</returns>
  property gc_ptr(String) ConflateEvents { gc_ptr(String) get(); }
  ...
  property TimeSpan SuspendedTxTimeout { TimeSpan get(); }
 ...
 private:
  ...
  inline SystemProperties(native::SystemProperties* nativeptr) : m_nativeptr(nativeptr) {}
