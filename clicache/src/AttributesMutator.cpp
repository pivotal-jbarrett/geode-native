...
TimeSpan AttributesMutator<TKey, TValue>::SetEntryIdleTimeout(TimeSpan idleTimeout) {
  try {
    return TimeUtils::DurationToTimeSpan(
        m_nativeptr->get()->setEntryIdleTimeout(TimeUtils::TimeSpanToDurationCeil<std::chrono::seconds>(idleTimeout)));
  } finally {
...
GENERIC(class TKey, class TValue)
ExpirationAction AttributesMutator<TKey, TValue>::SetEntryIdleTimeoutAction(ExpirationAction action) {
  try {
    return static_cast<ExpirationAction>(
        m_nativeptr->get()->setEntryIdleTimeoutAction(static_cast<native::ExpirationAction>(action)));
  } finally {
    GC::KeepAlive(m_nativeptr);
  }
}
...
TimeSpan AttributesMutator<TKey, TValue>::SetEntryTimeToLive(TimeSpan timeToLive) {
  try {
    return TimeUtils::DurationToTimeSpan(
        m_nativeptr->get()->setEntryTimeToLive(TimeUtils::TimeSpanToDurationCeil<std::chrono::seconds>(timeToLive)));
  } finally {
    GC::KeepAlive(m_nativeptr);
  }
}
...
GENERIC(class TKey, class TValue)
ExpirationAction AttributesMutator<TKey, TValue>::SetEntryTimeToLiveAction(ExpirationAction action) {
  try {
    return static_cast<ExpirationAction>(
        m_nativeptr->get()->setEntryTimeToLiveAction(static_cast<native::ExpirationAction>(action)));
  } finally {
    GC::KeepAlive(m_nativeptr);
  }
}
...
TimeSpan AttributesMutator<TKey, TValue>::SetRegionIdleTimeout(TimeSpan idleTimeout) {
  try {
    return TimeUtils::DurationToTimeSpan(
        m_nativeptr->get()->setRegionIdleTimeout(TimeUtils::TimeSpanToDurationCeil<std::chrono::seconds>(idleTimeout)));
  } finally {
    GC::KeepAlive(m_nativeptr);
  }
}
...
GENERIC(class TKey, class TValue)
ExpirationAction AttributesMutator<TKey, TValue>::SetRegionIdleTimeoutAction(ExpirationAction action) {
  try {
    return static_cast<ExpirationAction>(
        m_nativeptr->get()->setRegionIdleTimeoutAction(static_cast<native::ExpirationAction>(action)));
  } finally {
    GC::KeepAlive(m_nativeptr);
  }
}
...
TimeSpan AttributesMutator<TKey, TValue>::SetRegionTimeToLive(TimeSpan timeToLive) {
  try {
    return TimeUtils::DurationToTimeSpan(
        m_nativeptr->get()->setRegionTimeToLive(TimeUtils::TimeSpanToDurationCeil<std::chrono::seconds>(timeToLive)));
  } finally {
    GC::KeepAlive(m_nativeptr);
  }
}
...
GENERIC(class TKey, class TValue)
ExpirationAction AttributesMutator<TKey, TValue>::SetRegionTimeToLiveAction(ExpirationAction action) {
  try {
    return static_cast<ExpirationAction>(
        m_nativeptr->get()->setRegionTimeToLiveAction(static_cast<native::ExpirationAction>(action)));
  } finally {
    GC::KeepAlive(m_nativeptr);
  }
}
