...
PUBLIC ref class CacheStatistics sealed {
 public:
  ...
  /// </returns>
  inline static gc_ptr(CacheStatistics) Create(std::shared_ptr<apache::geode::client::CacheStatistics> nativeptr) {
    return __nullptr == nativeptr ? nullptr : gcnew CacheStatistics(nativeptr);
  }
 ...
 private:
  ...
  gc_ptr(native_shared_ptr<native::CacheStatistics>) m_nativeptr;
};
}  // namespace Client
}  // namespace Geode
}  // namespace Apache
