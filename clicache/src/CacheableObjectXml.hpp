...
/// </para>
/// </remarks>
PUBLIC ref class CacheableObjectXml : public ISerializable {
 public:
  /// <summary>
  ...
  /// </remarks>
  inline static gc_ptr(CacheableObjectXml) Create(gc_ptr(Object) value) {
    return (value != nullptr ? gcnew CacheableObjectXml(value) : nullptr);
  }
