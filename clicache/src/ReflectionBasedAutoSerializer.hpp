...
PUBLIC ref class ReflectionBasedAutoSerializer : IPdxSerializer {
 public:
  virtual bool ToData(gc_ptr(Object) o, gc_ptr(IPdxWriter) writer);

  virtual gc_ptr(Object) FromData(gc_ptr(String) o, gc_ptr(IPdxReader) reader);
  ...
  virtual gc_ptr(String) GetFieldName(gc_ptr(FieldInfo) fi, gc_ptr(Type) type);
  ...
  virtual bool IsIdentityField(gc_ptr(FieldInfo) fi, gc_ptr(Type) type);
  ...
  virtual FieldType GetFieldType(gc_ptr(FieldInfo) fi, gc_ptr(Type) type);
  ...
  virtual bool IsFieldIncluded(gc_ptr(FieldInfo) fi, gc_ptr(Type) type);
  ...
  virtual gc_ptr(Object) CreateObject(gc_ptr(String) className, gc_ptr(Cache) cache);

  ReflectionBasedAutoSerializer();

 private:
  FieldType getPdxFieldType(gc_ptr(Type) type);

  void serializeFields(gc_ptr(Object) o, gc_ptr(IPdxWriter) writer);

  gc_ptr(Object) deserializeFields(gc_ptr(String) o, gc_ptr(IPdxReader) reader);
