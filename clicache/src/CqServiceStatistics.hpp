...
PUBLIC ref class CqServiceStatistics sealed {
 public:
  ...
  /// </returns>
  inline static gc_ptr(CqServiceStatistics)
      Create(std::shared_ptr<apache::geode::client::CqServiceStatistics> nativeptr) {
    return __nullptr == nativeptr ? nullptr : gcnew CqServiceStatistics(nativeptr);
  }
 ...
 private:
  ...
  gc_ptr(native_shared_ptr<native::CqServiceStatistics>) m_nativeptr;
};
}  // namespace Client
}  // namespace Geode
}  // namespace Apache
